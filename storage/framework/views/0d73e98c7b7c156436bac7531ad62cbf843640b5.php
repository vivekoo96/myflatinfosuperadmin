                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <?php if(!empty($photos) && count($photos) > 0): ?>
                            <a href="<?php echo e($photos[0]['photo']); ?>"
                               target="_blank"
          ...
          <div class="form-group building-selection" style="display:none;">
            ...
            <select name="selected_buildings[]" id="selected_buildings" class="form-control select2" multiple>
              <?php $__currentLoopData = \App\Models\Building::orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($building->id); ?>" <?php echo e((old('selected_buildings') && in_array($building->id, old('selected_buildings'))) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/superadmin.myflatinfo.com/resources/views/admin/classified/index.blade.php ENDPATH**/ ?>