...
<script>
  $(function () {
    ...
    function uploadImage(file, editor) {
      ...
      // Create local URL for the image with proper styling
      var reader = new FileReader();
      reader.onload = function(e) {
        var imageNode = $('<img>')
          .attr('src', e.target.result)
          .attr('alt', 'Terms & Conditions image')
          .css({
            'max-width': '100%',
            'height': 'auto',
            'display': 'block',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/dev.superadmin.myflatinfo.com/resources/views/admin/settings/terms_conditions.blade.php ENDPATH**/ ?>