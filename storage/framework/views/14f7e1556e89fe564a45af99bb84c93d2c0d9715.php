    ...
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('ads.store')); ?>" method="post" class="add-form" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="name" class="col-form-label">Image:(max 2mb) <img src="<?php echo e(asset('images/default-ad.png')); ?>" id="image2" style="width:40px"></label>
  ...
  $(document).ready(function(){
    ...
    $('#addModal').on('show.bs.modal', function (event) {
      ...
      if (fromTime) {
        ...
        $('#from_time').val(fromDate.toISOString().slice(0, 16));
      } else {
        $('#from_time').val('');
      }
      if (toTime) {
        var toDate = new Date(toTime);
        $('#to_time').val(toDate.toISOString().slice(0, 16));
      } else {
        $('#to_time').val('');
      }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vivekpatel/Herd/newupdatedcode/resources/views/admin/ads/index.blade.php ENDPATH**/ ?>