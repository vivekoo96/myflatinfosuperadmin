            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(url('update-privacy-policy')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <label>Privacy Policy</label>
                                    <textarea name="privacy_policy" id="summernote" class="form-control"><?php echo $privacy_policy; ?></textarea>
                                </div>
                                <div class="form-group">
...
<script>
  $(function () {
    ...
    function uploadImage(file, editor) {
      ...
      $.ajax({
        url: "<?php echo e(url('upload-image')); ?>", // You'll need to create this route
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/test.superadmin.myflatinfo.com/resources/views/admin/settings/privacy_policy.blade.php ENDPATH**/ ?>