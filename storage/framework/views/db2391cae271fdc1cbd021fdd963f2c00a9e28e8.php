            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php $i++; ?>
                  <tr>
                    <td style="text-align:center; vertical-align:top; white-space:nowrap;"><?php echo e($i); ?></td>
          <td>
           
              <img src="<?php echo e($user->photo); ?>" style="width:40px; height:40px; object-fit:cover;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/test.superadmin.myflatinfo.com/resources/views/admin/admin/index.blade.php ENDPATH**/ ?>