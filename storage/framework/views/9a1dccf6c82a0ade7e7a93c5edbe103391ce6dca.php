            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(url('update-delete-account-policy')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <label>Delete Account Policy</label>
                                    <textarea name="delete_account_policy" id="summernote" class="form-control"><?php echo $delete_account_policy; ?></textarea>
                                </div>
                                <div class="form-group">
...
<script>
  $(function () {
    ...
    $('#summernote').summernote({
      ...
      minHeight: 200,
      maxHeight: 600,
      placeholder: 'Enter Delete Account Policy content here...',
      toolbar: [
        ['style', ['style']],
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/test.superadmin.myflatinfo.com/resources/views/admin/settings/delete_account_policy.blade.php ENDPATH**/ ?>