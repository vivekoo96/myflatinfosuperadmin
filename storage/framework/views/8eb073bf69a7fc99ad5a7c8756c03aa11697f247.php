          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <!--<p class="text-muted text-center"><strong><?php echo e($customer->role); ?></strong></p>-->

                <ul class="list-group list-group-unbordered mb-3">
                    
                      <li class="list-group-item">
                    <b>Name</b> 
                    <a class="float-right address"> <?php echo e($customer->first_name); ?>  <?php echo e($customer->last_name); ?></a>
                  </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(url('update-profile')); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <?php if($customer->hasPermission('menu.profile')): ?>
                      <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/test.superadmin.myflatinfo.com/resources/views/admin/profile.blade.php ENDPATH**/ ?>