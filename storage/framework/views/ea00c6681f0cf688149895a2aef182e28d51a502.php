    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <a href="<?php echo e($user->hasPermission('menu.builders') ? route('builder.index') : 'javascript:void(0);'); ?>"
                        <?php if (! ($user->hasPermission('menu.builders'))): ?> data-toggle="modal" data-target="#accessDeniedModal" <?php endif; ?>>
                        <div class="small-box bg-info">
                            <div class="inner">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vivekpatel/Herd/newupdatedcode/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>