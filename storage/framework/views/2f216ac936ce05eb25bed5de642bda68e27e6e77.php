...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(url('/')); ?>">
        <center>
            <img src="<?php echo e($setting->logo); ?>" alt="AdminLTE Logo" class="brand-image" style="width:100%" height="160px">
        </center>
    </a>
    <?php $user = Auth::User(); ?>
    <!-- Sidebar -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="<?php echo e(url('/info')); ?>" target="_blank">Myflat info</a>.</strong> All rights reserved.
  </footer>
...
<?php /**PATH /Users/vivekpatel/Herd/newupdatedcode/resources/views/layouts/admin.blade.php ENDPATH**/ ?>