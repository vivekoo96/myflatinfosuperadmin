    ...
    <div class="app-info-container">
        ...
        <div class="info-card">
            <div class="info-header bg-white">
                <img src="{{$setting->logo}}" alt="My Flat Info Logo">
                <h1>My Flat Info</h1>
            ...
            <div class="info-body">
                <div class="info-section">
                    ...
                    <p>{!! strip_tags($setting->about_us ?? 'My Flat Info is a comprehensive apartment and building management system for residents, administrators, and property managers.') !!}</p>
                </div>
                ...
                <div class="info-section">
                    ...
                    <p><strong>Business Name:</strong> {{$setting->business_name}}</p>
                    <p><strong>Email:</strong> {{$setting->email ?? 'info@myflatinfo.com'}}</p>
                ...
                <div class="text-center mt-4">
                    <p class="text-muted">© {{ date('Y') }} My Flat Info. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
