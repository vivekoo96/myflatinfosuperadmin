...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/')}}">
        <center>
            <img src="{{$setting->logo}}" alt="AdminLTE Logo" class="brand-image" style="width:100%" height="80px">
        </center>
    </a>
    <?php $user = Auth::User(); ?>
    <!-- Sidebar -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!--</li> -->
            ...
            @if($user->hasPermission('menu.dashboard'))
          <li class="nav-item">
          ...
          @if($user->hasPermission('menu.profile'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.admins'))
          <li class="nav-item">
            <a href="{{url('/admins')}}" class="nav-link {{ request()->is('admin*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-users-cog"></i>
              <p>Admins</p>
            </a>
          </li>
          @endif
          @if($user->hasPermission('menu.customers'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.building.admins'))
          <li class="nav-item">
            <a href="{{url('/building-admins')}}" class="nav-link {{ request()->is('building-admins*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-user-tie"></i>
              <p>Building Admins</p>
            </a>
          </li>
          @endif
          @if($user->hasPermission('menu.ads'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.builder'))
          <li class="nav-item">
            <a href="{{route('builder.index')}}" class="nav-link {{ request()->is('builder*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-hard-hat"></i>
              <p>Builder</p>
            </a>
          </li>
          @endif
          @if($user->hasPermission('menu.buildings'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.city'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.permissions'))
          <!--<li class="nav-item">-->
          ...
          <!--</li>-->
          @endif
          @if($user->hasPermission('menu.settings'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.classified'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.taxes'))
          <!--<li class="nav-item">-->
          ...
          <!--</li>-->
          @endif
          @if($user->hasPermission('menu.privacy.policy'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.terms.conditions'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.about.us'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.return.and.refund.policy'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.cancellation.policy'))
          <li class="nav-item">
          ...
          @endif
          @if($user->hasPermission('menu.delete.account.policy'))
          <li class="nav-item">
            <a href="{{url('delete-account-policy')}}" class="nav-link {{ request()->is('delete-account-policy') ? 'active' : '' }}">
              <i class="nav-icon fas fa-user-times"></i>
              <p>Delete Account Policy</p>
            </a>
          </li>
          @endif
          @if($user->hasPermission('menu.faqs'))
          <li class="nav-item">
  ...
  var firebaseConfig = {
    ...
    async function startFCM() {
        try {
            ...
            const response = await fetch('{{ route("save.token") }}', {
                method: 'POST',
                headers: {
...
$(document).ready(function(){
    ...
    $(function () {
        $(".table").DataTable({
          "responsive": false, "scrollX": true, "ordering": true, "lengthChange": false, "autoWidth": false,"bPaginate": true,"bInfo": false,"searching": true,"pageLength": parseInt("{{$setting->pagination}}"),
          order: [[0, 'asc']],
          buttons: [
            {
                extend: 'csvHtml5',
