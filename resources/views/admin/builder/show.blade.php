                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <a href="{{url('building-admin/' . $building->user->id)}}" class="text-primary" style="text-decoration: none; font-weight: 500;">{{$building->user->name}}</a>
                                        <br><small class="text-muted">Total Buildings: {{$building->user->buildings->count()}}</small>
                                    </td>
                                    <td>{{$building->user ? $building->user->email : 'N/A'}}</td>
                                    <td>{{$building->user->phone}}</td>
        ...
        <div class="modal-body">
          ...
          <div class="form-group" id="existing-ba-section" style="display: none;">
            ...
            <select name="existing_ba" id="existing_ba" class="form-control">
                ...
                @forelse($building_admins as $ba)
                <option value="{{$ba->id}}">{{$ba->name}} ({{$ba->email}}) - Buildings: {{$ba->buildings->count()}}</option>
                @empty
            ...
            <div class="col-md-6">
                <label for="name" class="col-form-label">For Month:</label>
                 <input type="number"
                  ...
                  placeholder="Enter number of months"
                  required>
                {{-- <input type="number" name="all_for_month" id="all_for_month" class="form-control" min="0" step="1" pattern="[0-9]+" placeholder="Enter months (minimum 0)" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required> --}}
                <small class="form-text text-muted">Enter number of months</small>
            </div>
          </div>
