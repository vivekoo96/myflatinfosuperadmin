              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$ad->name}}</td>
                    <td>{{ $ad->from_time ? \Carbon\Carbon::parse($ad->from_time)->format('d M Y, h:i A') : '-' }}</td>
                    <td>{{ $ad->to_time ? \Carbon\Carbon::parse($ad->to_time)->format('d M Y, h:i A') : '-' }}</td>
                    ...
                    <td>
                      ...
                      data-name="{{$ad->name}}" data-link="{{$ad->link}}" data-status="{{$ad->status}}" data-image="{{$ad->image}}" 
                      data-from_time="{{ $ad->from_time }}" data-to_time="{{ $ad->to_time }}"
                      data-notification_type="{{ $ad->notification_type }}"><i class="fa fa-edit"></i></button>
    ...
    <div class="modal-content">
      ...
      <form action="{{route('ads.store')}}" method="post" class="add-form" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="name" class="col-form-label">Image:(max 2mb) <img src="{{$building->image}}" id="image2" style="width:40px"></label>
