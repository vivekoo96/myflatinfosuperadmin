...
<head>
    ...
    <title>Reset Password | {{$setting->business_name}}</title>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="post" action="{{url('reset-password')}}">
                ...
                <input type="email" name="old_email" value="{{$password_reset->email}}" class="form-input" placeholder="Email Address" disabled required>
